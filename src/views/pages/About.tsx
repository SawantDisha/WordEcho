...
export default function About() {
    return <>
        ...
        <header
            className="masthead"
            style={{ backgroundImage: "url('https://images.pexels.com/photos/20643567/pexels-photo-20643567/free-photo-of-yellow-crocus-flowers.jpeg?auto=compress&cs=tinysrgb&w=1200&lazy=load')" }}
        >
